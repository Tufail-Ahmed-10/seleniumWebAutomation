...
public class SelectorTest {
    public static void main(String[] args) throws InterruptedException {
      ...
      Thread.sleep(3000);
      driver.findElement(By.partialLinkText(" in in "));
      driver.findElement(By.cssSelector("input[name='username']")).sendKeys("adsadsa");
        Thread.sleep(2000);
      driver.findElement(By.xpath("//input[@name='password']")).sendKeys("adsa");
      Thread.sleep(3000);
     List<WebElement> list = driver.findElements(By.tagName("a"));
     for(WebElement element:list){
         System.out.println(element.getText());
         System.out.println(element.getDomAttribute("herf"));
